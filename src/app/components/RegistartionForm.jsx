...
export default function RegistrationForm() {
  ...
  // Aapke Schema/Course JSON ke mutabiq Static IDs
    const DEFAULT_EVENT = "6998c6a3b1455d0ae8c566fc";
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    formData.append("event", DEFAULT_EVENT);
          ...
          <div className="bg-slate-900 text-white p-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter italic">
                Online Workshop <span className="text-red-600">Registrarion Form</span>
              </h2>
              <p className="text-slate-400 font-bold uppercase tracking-widest text-xs mt-1">
                YouTube Automation Workshop Online
              </p>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-slate-900/90 backdrop-blur-md">
          <div className="bg-white w-full max-w-md rounded-[2.5rem] p-10 text-center shadow-2xl relative overflow-hidden animate-in zoom-in duration-300">
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="https://chat.whatsapp.com/Cxnnbqm0qz4AaYvblXWgB1?mode=gi_t"
                target="_blank"
              ...
              >
                <FaIdCard /> Join Online Participant Whatsaap Group
              </Link>
              <Link
                href="/status"
